authorization do
  ...
  role :general_settings do
    ...
    has_permission_on [:student], :to => [:add_additional_details, :delete_additional_details, :edit_additional_details, :categories,:category_delete,:category_edit,:category_update,:schools,:school_delete,:school_edit,:school_update ]
  end
...
#      :additional_fees_delete,
  ...
  role :employee do
    ...
    has_permission_on [:plans], :to => [:index, :show, :export, :edit, :new, :create,:update, :destroy]
