...
ActiveRecord::Schema.define(:version => 20131106002838) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"batch_id"=>nil, "observable_type"=>nil, "student_id"=>nil, "observable_id"=>nil, "exam_id"=>nil}
