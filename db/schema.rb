...
ActiveRecord::Schema.define(:version => 20181205082909) do
  ...
  add_index "assessment_scores", ["student_id", "batch_id", "descriptive_indicator_id", "exam_id"], :name => "score_index", :limit => {"descriptive_indicator_id"=>nil, "student_id"=>nil, "batch_id"=>nil, "exam_id"=>nil}
  ...
  create_table "grade_definitions", :force => true do |t|
    t.string   "Name"
  ...
  create_table "ponderations", :force => true do |t|
    t.string   "Name"
    t.integer  "Value",              :limit => 10, :precision => 10, :scale => 0
    t.integer  "Subject_id"
    t.integer  "GradeDefinition_id"
  ...
  create_table "student_class_notes", :force => true do |t|
    t.integer  "OrderNumber"
    t.string   "Name"
    t.integer  "Value",       :limit => 10, :precision => 10, :scale => 0
    t.integer  "subject_id"
  ...
  create_table "student_class_notes_values", :force => true do |t|
    t.integer  "Value",       :limit => 10, :precision => 10, :scale => 0
